...
import org.apache.sedona.core.spatialOperator.KCPQuery;
        ...
        implements Serializable
{
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < eachQueryLoopTimes; i++) {
            ...
            long resultSize = KCPQuery.KClosestPairsQuery(objectRDD, queryRDD, PointRDDIndexType!=null, k, KCPQAlgorithm.REVERSE_FULL, sample).size();
